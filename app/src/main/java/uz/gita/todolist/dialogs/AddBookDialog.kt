...
private var listener : ((BookEntity) -> Unit)? = null
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val btnCancel : AppCompatButton = view.findViewById(R.id.cancelBook)
        val btnSave : AppCompatButton = view.findViewById(R.id.saveBook)
        val name : TextInputEditText = view.findViewById(R.id.addBookName)
        val startDate : TextInputEditText = view.findViewById(R.id.addStartDate)
        val finishDate : TextInputEditText = view.findViewById(R.id.finishDateInput)
        ...
        btnSave.setOnClickListener {
            listener?.invoke(BookEntity(0, name.text.toString(), startDate.text.toString(), finishDate.text.toString()))
            dismiss()
        }
    }
